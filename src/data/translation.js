export const translation = {
	uk: {
		notes_title: "Нотатки",
		notes_placeholder: "Введи нотатку",
		add_button: "Додати",
		delete_button: "Видалити",
		notes_app: "Ваш персональний комп'ютер для запису нотаток",
	...
	eng: {
		notes_title: "Notes",
		notes_placeholder: "Enter a note",
		add_button: "Add",
		delete_button: "Delete",
		notes_app: "Your personal note-taking app",
